...
#################### Run the code 10 times with different seeds ##################
for i in range(10):
...
# Calculate and print the averag
average_kb = np.mean(final_kb_values)
average_kg = np.mean(final_kg_values)


print(f'Average kb absolute error: {average_kb}')
print(f'Average kg absolute error: {average_kg}')
